class EmployeeForm
	...
	attr_accessor :job_title, :employee_num, :employment_start_date, :employment_end_date, :biography, :agma_artist
	...
	delegate :job_title, :employee_num, :employment_start_date, :employment_end_date, :biography, :agma_artist, to: :employee
	...
	def submit(params)
		employee.attributes = params.slice(:job_title, :employee_num, :employment_start_date, :employment_end_date, :biography, :agma_artist)
